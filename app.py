...
def summarize_text(text, department):
    with st.spinner("Samenvatting maken..."):
        department_prompts = {
            ...
            "Algemene samenvatting": "Jij bent een expert in het samenvatting van elk soort notitie, gesprek of wat er ook maar wordt aangeleverd. Je geeft een complete samenvatting, met specifiek oog voor de details, maar je vermijd herhaling en probeert er voor te zorgen dat de samenvatting beknopt is. Maar volledigheid gaat altijd boven de beknoptheid. Je zorgt ervoor dat alle afspraken, actiepunten en andere elementen duidelijk worden overgenomen. Het moet zo zijn dat als iemand de notitie leest, hij/zij net zoveel weet als wanneer hij bij het gesprek was."
        }
