...
def load_prompt(department):
    # Map the department name directly to the file name, adjusting for case and spaces
    file_name = department.replace(' ', '_').lower() + '.txt'  # Assuming file naming convention matches this pattern
